package com.pay.ysspay.client.controller;

import com.jfinal.core.Controller;
import com.pay.yeepay.client.service.YeepayService;

public class Ysspay extends Controller {

	public void payresult(){
		renderJsp("/WEB-INF/pay/ysspay/payresult.jsp");
	}
	
	public void paymentpayresult(){
		renderJsp("/WEB-INF/pay/ysspay/paymentpayresult.jsp");
	}
