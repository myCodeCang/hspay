...
public class Paydo extends Controller {
	...
	public void index() throws UnsupportedEncodingException {
		...
		//String PostUrl = "http://htpay.chenglf.com/hspay/node";
		//String PostUrl = "http://sj.miaojiesuan.net/hspay/node";
		...
		String p5_Pid = new String("OnlinePay".getBytes(),"UTF-8"); // 商品名称 否 Max(20) 用于支付时显示在易宝支付网关左侧的订单产品信息.
		String p6_Pcat = "W3C"; // 商品种类 否 Max(20) 商品种类.
		String p7_Pdesc = "Online Payment Goods."; // 商品描述 否 Max(20) 商品描述.
		...
		if(bankCardType.equals("01")){
			...
			String pz_userId="";
			p8_Url=basePath + "/paydo/callbackCrad/";
	...
	public void callback() throws IOException {
		...
		out.print("setTimeout(function(){window.location.href='"+basePath+"/index_tf/test_callback.jsp?reulst="+URLEncoder.encode(reulst, "utf-8")+"';},500);");
		out.print("</script>");
		out.print(" </body>");
		out.print("</html>");
		out.flush();
