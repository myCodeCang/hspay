...
public class PaymentForOnlineService {
	...
	public static QueryResult queryByOrder(String p2_Order) {
		...
		newHmac = DigestUtil.getHmac(
				new String[] { qr.getR0_Cmd(), qr.getR1_Code(), qr.getR2_TrxId(), qr.getR3_Amt(), qr.getR4_Cur(),
						qr.getR5_Pid(), qr.getR6_Order(), qr.getR8_MP(), qr.getRb_PayStatus(), qr.getRc_RefundCount(),
	...
	public static RefundResult refundByTrxId(String pb_TrxId, String p3_Amt, String p4_Cur, String p5_Desc) {
		...
		String hmac = DigestUtil.getHmac(new String[] { refund_Cmd, p1_MerId, pb_TrxId, p3_Amt, p4_Cur, p5_Desc },
				keyValue);
		Map<String, String> reParams = new HashMap<String, String>();
		...
		String newHmac = "";
		newHmac = DigestUtil.getHmac(new String[] { rr.getR0_Cmd(), rr.getR1_Code(), rr.getR2_TrxId(), rr.getR3_Amt(),
...
//		boolean boo = verifyCallback("39ae679c426d33352694c340283e8371", "10012216266", "Buy", "1", "714226256519841I",
//				"0.2", "RMB", "admin(海阳浩松网络科技有限公司余额", "OR201402370902825013894622", "", "charge-user_charge-1-0-1-0",
//				"2", "3jXt43jsT756qmN080Y06RsiU5z2Ez66R3s3Woi6NZWV08549AX88rne7841");
