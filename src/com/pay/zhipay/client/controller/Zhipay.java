 ...
 * 
 */
package com.pay.zhipay.client.controller;
 ...
 *
 */
public class Zhipay extends Controller {

	public void zhipayToMer() {
		renderJsp("/WEB-INF/pay/zhipay/zhipayToMer.jsp");
	}

	public void paymentZhipayToMer() {
		renderJsp("/WEB-INF/pay/zhipay/paymentzhipayToMer.jsp");
	}
	...
	public void sweeppayment() throws DocumentException {
		...
		if (resp_code.equals("SUCCESS")) {
			...
			if ("0".equals(result_code) && StringUtil.isNotBlank(qrcode)) {
				...
				renderJsp("/WEB-INF/pay/zhipay/sweeppayment.jsp");
			} else {
