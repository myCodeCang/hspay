...
public class Ddpay extends Controller {

	public void dinpayToMer() {
		renderJsp("/WEB-INF/pay/ddpay/DinpayToMer.jsp");
	}

	public void paymentDinpayToMer() {
		renderJsp("/WEB-INF/pay/ddpay/paymentDinpayToMer.jsp");
	}
	...
	public void sweeppayment() throws DocumentException {
		...
		if (resp_code.equals("SUCCESS")) {
			...
			String interface_version = element
					.elementTextTrim("interface_version");
