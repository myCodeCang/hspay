...
<%
	...
	if("01".equals(BillType)){
		...
		titled+="，微信支付";
	}else if("010500".equals(BillType)){
		titled+="QQ钱包支付";
	}
	if("1".equals(BillNo)){
		out.println("暂未开放此接口！");
...
function jumpUrl()
{
	document.location.href="<%=basePath %>/payment/showPayOk";
}
...
<div class="wrap">
    ...
    <div class="right">
        <h1>请扫码支付，金额：<span class="orange"><span class="orange"><%=transAmt %>.00</span>元</span></h1>
        <div class="ewm">
