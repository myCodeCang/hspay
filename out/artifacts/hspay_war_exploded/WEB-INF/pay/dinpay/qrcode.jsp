...
<%
	 ...
	 **/
	 ////////////////////////////////////请求参数//////////////////////////////////////
		...
		// 支付请求地址
		String reqUrl = "https://api.zhihpay.com/gateway/api/scanpay";
		String result = null;
		//参数编码字符集(必选)
		...
		//客户端IP（选填）
		String client_ip ="49.10.162.2";// (String) request.getAttribute("client_ip");
		String redo_flag ="1";
...
<form name="dinpayForm" method="post" action="<%=basePath %>/dinpay/sweeppayment">
	<input type="hidden" name="result" value="<%=result%>" />
	<input type="hidden" name="service_type" value="<%=service_type%>" />
	<input type="hidden" name="goodsTitle" value="<%=product_name%>"/>
	</form>
</body>
