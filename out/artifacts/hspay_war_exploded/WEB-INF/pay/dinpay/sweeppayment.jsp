...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path;
	String wxurl="";
	String wxurl1 = DigestUtil.toEmpty((String) request.getAttribute("wxurl"));
	String wxurl2 = DigestUtil.toEmpty((String) request.getAttribute("wxurl2"));
	...
	if(wxurl1.equals("") || wxurl1==null){
		wxurl=wxurl2;
	}else{
		wxurl=basePath+wxurl1;
	}
%>
...
<div class="wrap">
    ...
    <div class="right">
        ...
        <div class="ewm">
           <div class="ewm-img"><img src="<%=wxurl %>" width="236"></div>
        </div>
    </div>
    <div class="clear"></div>
</div>
