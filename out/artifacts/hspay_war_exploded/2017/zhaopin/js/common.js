...
/* 右侧浮层 */
$(function(){
	$("#float").load("http://www.lianlianpay.com/shanghu/float.html", function(){
		...
		$('.float a').mouseover(function(){
			$(this).next('img').show();
			$(this).next('div').show();
		}).mouseout(function(){
			$('.float li').find('div, img').hide();
		})
		
		$('.float li > div, .float li > img').mouseover(function(){
			$(this).show();
		}).mouseout(function(){
			$(this).hide();
		})
