...
<div class="about_us_top">
  ...
  <div class="about_us_main">
      ...
      <!--左边结束-->
      <div class="about_us_main_r right relative">
      <div class="left width720 margint30">
       <div id="banner_news_4" class="banner_news_4"></div>
            ...
            <h3 id="dtitle"></h3>
            <h5><span class="right marginr10"><img src="<%=basePath%>/index_tf/pic/blue_arrow.gif" class="marginr10"/><a href="javascript:history.go(-1);"  class="blue_a">返回</a></span><!--编辑：lilei--><span id="ddate"></span></h5>
            ...
            <div id="dcontent">    
               ...
               $(document).ready(function(){
            		...
            		$.ajax({
            			type : "POST",
            			url : baseurl+"/getDynamic",
            			data : {dynamicid:<%=request.getParameter("dynamicid")%>},
            			dataType : "json",
            			async : "false",
            			success : function(data) {
            				$("#dtitle").html(data.title);
            				$("#ddate").html("日期："+data.createtime);
